...
public class Usuario {
    ...
    public Usuario(int idUsuario, String nombre, String apellidoPaterno, String apellidoMaterno, String celular, String usuario, String contrasena, int idRol, int idEstatus, int idRancho, int idUsuarioAlta, String fechaAlta, int idUsuarioEditor, String fechaEdicion) {
    ...
    public Usuario(int idUsuario, String nombre, String apellidoPaterno, String apellidoMaterno, String celular, String usuario, String contrasena, int idRol, String rol, int idEstatus, String estatus, int idRancho, String rancho, int idUsuarioAlta, String usuarioAlta, String fechaAlta, int idUsuarioEditor, String usuarioEditor, String fechaEdicion) {
        this.idUsuario = idUsuario;
        this.nombre = nombre;
        this.apellidoPaterno = apellidoPaterno;
        this.apellidoMaterno = apellidoMaterno;
